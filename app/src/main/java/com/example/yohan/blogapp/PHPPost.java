...
public class PHPPost extends AppCompatActivity implements RecentPostAdapter.onItemClicked{
    ...
    private String PHPBaseURL = "https://sinhala.readhub.lk/wp-json/wp/v2/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("PHP Articles");
    ...
    public class GetPHPJson extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Call<List<WPPost>> call = retrofitArrayAPI.getPHPPost();
...
//            progressDialog.dismiss();
    ...
    public class GetPHPJson1 extends AsyncTask<Void,Void,Void> {
