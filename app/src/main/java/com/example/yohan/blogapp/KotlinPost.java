...
public class KotlinPost extends AppCompatActivity implements RecentPostAdapter.onItemClicked {

    private Toolbar mToolbar;
    private RecyclerView KotlinrecyclerView;
    ...
    private String KoltinBaseURL = "https://english.readhub.lk/wp-json/wp/v2/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kotlin_post);

        mToolbar = findViewById(R.id.KotlinPost_app_bar);
        setSupportActionBar(mToolbar);


        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ReadHub - Kotlin");
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("Kotlin Articles");
    ...
    public class GetKotlinJson extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.dismiss();
    ...
    public class GetKotlinJson1 extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.dismiss();
    ...
    private void InitListner(){
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recentPostAdapter.SetOnItemClickListener(KotlinPost.this);
    ...
    private void updateUI(){
        Intent startIntent = new Intent(KotlinPost.this,Login.class);
    ...
    public void connectionDialog1(){
        MyDialog1 = new Dialog(KotlinPost.this);
