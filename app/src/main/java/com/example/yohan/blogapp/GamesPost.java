...
public class GamesPost extends AppCompatActivity implements RecentPostAdapter.onItemClicked {
   ...
   // private SwipeRefreshLayout swipeRefreshLayout;
    ...
    private String GamesBaseURL = "https://sinhala.readhub.lk/wp-json/wp/v2/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  swipeRefreshLayout = findViewById(R.id.GamesSwipe);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("Games Articles");
    ...
    public class GetGamesJson extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Call<List<WPPost>> call = retrofitArrayAPI.getGamesPost();
    ...
    public class GetGamesJson1 extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.dismiss();
    ...
    public void connectionDialog1(){
        MyDialog1 = new Dialog(GamesPost.this);
