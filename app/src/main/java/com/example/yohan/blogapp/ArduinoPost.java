...
public class ArduinoPost extends AppCompatActivity implements RecentPostAdapter.onItemClicked{

    private Toolbar mToolbar;

    private RecyclerView ArduinorecyclerView;
    ...
    private String ArduinoBaseURL = "https://sinhala.readhub.lk/wp-json/wp/v2/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arduino_post);

        mToolbar = findViewById(R.id.ArduinoPost_app_bar);

        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ReadHub - Arduino");
        ...
        progressDialog1 = new ProgressDialog(ArduinoPost.this);
        progressDialog1.setTitle("Arduino Posts");
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("Arduino Articles");
        ...
        ArduinorecyclerView = findViewById(R.id.Arduino_recycleview);

        linearLayoutManager = new LinearLayoutManager(ArduinoPost.this,LinearLayoutManager.VERTICAL,false);
        ArduinorecyclerView.setLayoutManager(linearLayoutManager);
        list = new ArrayList<RecentModel>();

        if(haveNetwork(getApplicationContext())){

            mDatabase.removeValue();
            new GetArduinoJson().execute();
            list.clear();
            InitListner();
    ...
    public class GetArduinoJson extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.show();
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Call<List<WPPost>> call = retrofitArrayAPI.getArduinoPost();
...
//            progressDialog.dismiss();
    ...
    public class GetArduinoJson1 extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.dismiss();
    ...
    private  void InitListner(){
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArduinorecyclerView.setAdapter(recentPostAdapter);
                recentPostAdapter.SetOnItemClickListener(ArduinoPost.this);
    ...
    private void updateUI(){
        Intent startIntent = new Intent(ArduinoPost.this,Login.class);
    ...
    public void connectionDialog1(){
        MyDialog1 = new Dialog(ArduinoPost.this);
