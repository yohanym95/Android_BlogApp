...
public class OtherPost extends AppCompatActivity implements RecentPostAdapter.onItemClicked{
 ...
 //   private SwipeRefreshLayout swipeRefreshLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("Entertainment Articles");
...
//            progressDialog.show();
    ...
    public class GetOtherJson1 extends AsyncTask<Void,Void,Void> {
