   ...
   // private SwipeRefreshLayout swipeRefreshLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // swipeRefreshLayout = findViewById(R.id.JavSwipe);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("JAVA Articles");
    ...
    public class GetJavaJson extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            Call<List<WPPost>> call = retrofitArrayAPI.getJavaPost();
...
//            progressDialog.dismiss();
    ...
    public class GetJavaJson1 extends AsyncTask<Void,Void,Void>{
