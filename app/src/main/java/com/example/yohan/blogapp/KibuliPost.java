...
public class KibuliPost extends AppCompatActivity implements RecentPostAdapter.onItemClicked{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("Kibuli Articles");
...
//            progressDialog.dismiss();
    ...
    public class GetKibuliJson1 extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.dismiss();
    ...
    public void connectionDialog1(){
        MyDialog1 = new Dialog(KibuliPost.this);
