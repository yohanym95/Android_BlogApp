...
public class NetworkingPost extends AppCompatActivity  implements RecentPostAdapter.onItemClicked{
   ...
   // private SwipeRefreshLayout swipeRefreshLayout;
    ...
    private String NetworkingBaseURL = "https://english.readhub.lk/wp-json/wp/v2/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Articles").child(userId).child("Networking Articles");
...
//            progressDialog.dismiss();
    ...
    public class GetNetworkJson1 extends AsyncTask<Void,Void,Void> {
...
//            progressDialog.dismiss();
    ...
    public void connectionDialog1(){
        MyDialog1 = new Dialog(NetworkingPost.this);
